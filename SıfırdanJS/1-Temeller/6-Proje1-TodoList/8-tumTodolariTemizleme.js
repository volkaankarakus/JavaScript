...
function eventListeners(){  // Tum event listenerlar
    ...
    clearButton.addEventListener("click",clearAllTodos); // 8
}
...
function clearAllTodos(e){
    if(confirm("Tumunu silmek istediginize emin misiniz?")){
        // arayuzden todolari temizleme
          // todoList.innerHTML = ""; yapip li'leri temizleyebiliriz ama bu yavas bir kod.
        
          // ilk elementChild 0'lanana kadar sil
        while(todoList.firstElementChild != null){
            todoList.removeChild(todoList.firstElementChild);
        }
        localStorage.removeItem("todos"); // storage'dan da todos arrayini silersek hepsi gider. 
    }
}
